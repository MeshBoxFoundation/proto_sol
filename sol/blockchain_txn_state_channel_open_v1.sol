...
library SmartmeshBlockchain_txn_state_channel_open_v1 {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 4) {
        pointer += _read_expire_within(pointer, bs, r);
      } else
      if (fieldId == 5) {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_int64(r.amount, pointer, bs);
    }
    if (r.expire_within != 0) {
    pointer += ProtoBufRuntime._encode_key(
      4,
      ProtoBufRuntime.WireType.Varint,
      pointer,
    ...
    pointer += ProtoBufRuntime._encode_int64(r.expire_within, pointer, bs);
    }
    if (r.oui != 0) {
    pointer += ProtoBufRuntime._encode_key(
      5,
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_int64(r.amount);
    e += 1 + ProtoBufRuntime._sz_int64(r.expire_within);
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.expire_within = input.expire_within;
